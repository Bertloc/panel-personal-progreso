    ...
    <div class="manager">
      ...
      <form [formGroup]="form" (ngSubmit)="save()">
        <div class="field-grid">
          ...
          <label>Monto inicial * <input formControlName="initialAmount" type="number" min="0.01" step="0.01" />@if (form.controls.initialAmount.touched && form.controls.initialAmount.invalid) { <span class="field-error">El monto inicial debe ser mayor que 0.</span> }</label>
          <label>Monto actual * <input formControlName="currentAmount" type="number" min="0" step="0.01" />
